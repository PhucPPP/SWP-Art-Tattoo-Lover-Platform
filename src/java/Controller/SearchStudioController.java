 ...
 * @author ASUS
 */
@WebServlet(name = "SearchStudioController", urlPatterns = {"/SearchStudioController"})
public class SearchStudioController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = ERROR;
        try {
            String search = request.getParameter("searchStudio");

            StudioDAO studioDao = new StudioDAO();
            List<StudioDTO> listStudio = studioDao.getListStudio(search);
            ...
            log("Error at SearchStudioController" + e.toString());
        } finally {
