 ...
 * @author thanh
 */
@WebServlet(name = "BookingDetailManagerController", urlPatterns = {"/BookingDetailManagerController"})
public class BookingDetailManagerController extends HttpServlet {

    private static final String ERROR = "BookingDetailManager.jsp";
    private static final String SUCCESS = "BookingDetailManager.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (bookingDetailList.size() > 0) {
                ...
                String studioID = booking.getStudioID();
                String bookDate = booking.getBookingDate();
                String slotID = booking.getSlotID();
                List<UserDTO> artistList = stuDao.getArtistAvailableList(studioID, bookDate, slotID);
            ...
            log("Error at BookingDetailManagerController: " + e.toString());
        } finally {
