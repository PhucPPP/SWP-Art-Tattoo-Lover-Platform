...
public class BookListController extends HttpServlet {
     ...
     */
    private static final String ERROR = "BookingList.jsp";
    private static final String SUCCESS = "BookingList.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<BookingDTO> bookingList = bookDao.getListBookingUser(userID);
            ...
            log("Error at BookingListController: " + e.toString());
        } finally {
