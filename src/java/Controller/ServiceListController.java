...
@WebServlet(name = "ServiceListController", urlPatterns = {"/ServiceListController"})
public class ServiceListController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (serviceList.size() > 0 || serviceDetialList.size() > 0 || serviceDetialList.size() > 0) {
            ...
            log("Error at ServiceListController: " + e.toString());
        } finally {
