 ...
 * @author laptop
 */
@WebServlet(name = "editPriceConfirmController", urlPatterns = {"/editPriceConfirmController"})
public class editPriceConfirmController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (ServiceSizeDTO size : sizeList) {
                ...
                serviceDao.updatePriceList(user.getId(), studioID, serviceID, serviceDetailID, size.getServiceSizeID(), price);
            }
//                INSERT INTO Studio_Service(studioStaffID,studioID,serviceID,serviceDetailID,serviceSizeID,price,status) VALUE(,)

        } catch (Exception e) {
            log("Error ar EditPriceConfirmController: " + e.toString());
        } finally {
