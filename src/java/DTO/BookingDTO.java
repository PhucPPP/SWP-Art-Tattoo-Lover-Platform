...
public class BookingDTO {
    ...
    public BookingDTO(String bookingID, String userID, String studioID, String studioStaffID, String slotID, int totalPrice, String description, String currentDate, String bookingDate, int rating, String commentation, String status) {
