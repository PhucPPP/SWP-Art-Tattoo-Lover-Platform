        ...
        try {
            ...
            if (conn != null) {
                ...
                while (rs.next()) {
                    ...
                    boolean status = rs.getBoolean("status");
                    if (status == true) {
                        list.add(new StudioServiceDTO(null, studioID, serviceID, serviceName, null, null, null, null, null, 0, status));
                    }
                }
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (conn != null) {
                ...
                while (rs.next()) {
                    ...
                    boolean status = rs.getBoolean("status");
                    if (status == true) {
                        list.add(new StudioServiceDTO(null, studioID, null, null, serviceDetailID, serviceDetailName, null, null, null, 0, status));
                    }
                }
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (conn != null) {
                ...
                while (rs.next()) {
                    ...
                    list.add(new StudioServiceDTO(null, studioID, null, null, null, null, null, null, null, minPrice, true));
        ...
        try {
            ...
            if (conn != null) {
                ...
                while (rs.next()) {
                    ...
                    list.add(new StudioServiceDTO(null, studioID, null, null, null, null, null, null, null, maxPrice, true));
        ...
        try {
            ...
            if (conn != null) {
                ...
                while (rs.next()) {
                    ...
                    boolean status = rs.getBoolean("status");
                    if (status == true) {
                        list.add(new StudioServiceDTO(null, null, serviceID, serviceName, serviceDetailID, serviceDetailName, null, null, null, 0, status));
                    }
                }
            }
        } catch (Exception e) {
