...
public class LoginController extends HttpServlet {
    ...
    private static final String SA_PAGE = "adminPage.jsp";
        ...
        try {
            ...
            if (us != null) {
                if (password.equals(us.getPassword())) {
                    ...
                    request.setAttribute("ERROR_PASSWORD", "* Mật khẩu không chính xác!");
                    url = ERROR;
                }
            } else {
                request.setAttribute("ERROR_USERNAME", "* Tên tài khoản không chính xác!");
                url = ERROR;
            }
        } catch (Exception e) {
