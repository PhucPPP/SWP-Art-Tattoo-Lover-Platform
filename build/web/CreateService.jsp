<%-- 
    ...
    Created on : Nov 1, 2023, 7:37:29 AM
    Author     : hieu09097248
--%>
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="./Resource/css/createServiceStyle.css" />
    ...
    <body>
        ...
        <div class="container" id="blur">
            ...
            <form class="form-service" action="MainController" method="POST" enctype="multipart/form-data">   
                ...
                <p>Ảnh đại diện cho dịch vụ</p>
                <input type="file" name="avatar" accept=".png, .jpg, .jpeg" required="">
                <p class="msg-error">${requestScope.ERROR}</p>
                <div class="btn">
                    <button class="btn-create" name="action" value="ServiceCreate">TẠO</button>
                </div>
            </form>
