<%-- 
    ...
    Created on : Nov 14, 2023, 7:44:20 PM
    Author     : ASUS
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="Resource/css/forgetPassword.css">
            ...
            <div class="container2">
                ...
                <form action="MainController" method="POST">
                    <div class="EMAIL">
                        ...
                        <button class="btn-OTP" type="submit" name="action" value="SendOTP">GỬI OTP</button>
                    </div>
                </form>
                <p class="msg-error">${requestScope.EMAIL_MSG}</p>
                <form action="MainController" method="POST">
                    <div class="OTP">
                        <label for="password">OTP: </label>
                        <input type="text" name="otpValue" required="">
                    </div>
                    <p class="msg-error">${requestScope.OTP_MSG}</p>
                    
                        <a class="CONFIRM"><button type="submit" name="action" value="checkOTP">XÁC NHẬN</button></a>
