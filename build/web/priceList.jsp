        ...
        <div class="container">
            <div class="header">
                ...
                <div class="avatar-item">
                    <img onclick="drop()" class="avatar-img" src="https://th.bing.com/th/id/OIP.7Z0skq54kBfcHRPjlsvATgHaG_?pid=ImgDet&rs=1">
...
>>>>>>> 46860fd9c8195799510ba7b99c8b013849670722
            ...
            <div class="btn">
                <button type="submit" name="action" value="priceListAdd" class="confirm">Xác nhận</button>
            </div>
        </form>
        <%            }
        %>
