<%-- 
    Document   : CreateServiceDetail
    Created on : Nov 1, 2023, 2:25:01 PM
    Author     : hieu09097248
--%>
...
<html lang="en">
    <head>
        ...
        <title>TẠO CHI TIẾT DỊCH VỤ</title>
        <link rel="stylesheet" href="./Resource/css/createServiceDetailStyle.css" />
    ...
    <body>
        ...
        <div class="container" id="blur">
            ...
            <form class="form-service" action="MainController" method="POST" enctype="multipart/form-data">
                <p>Tên chi tiết dịch vụ</p>
                <input type="text" name="name" required="">
                <p>Ảnh đại diện cho chi tiết dịch vụ</p>
                <input type="file" name="avatar" accept=".png, .jpg, .jpeg" required="">
                <p class="msg-error">${requestScope.ERROR}</p>
                <div class="btn">
                    <button class="btn-create" name="action" value="ServiceDetailCreate">TẠO</button>
                </div>  
            </form>
