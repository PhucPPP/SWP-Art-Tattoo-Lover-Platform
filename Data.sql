...
insert [Booking_StudioService] ([bookingID], [studioServiceID], [artistID], amount, [status])
values ('B001', 'STSV015', null, 1, 1)
insert [Booking_StudioService]
values ('B001', 'STSV078', null, 1, 1)
insert [Booking_StudioService]
values ('B002', 'STSV074', 'SA001', 1, 1)
insert [Booking_StudioService]
values ('B003', 'STSV074', 'SA002', 1, 1)
insert [Booking_StudioService]
values ('B005', 'STSV141', 'SA004', 1, 1)
insert [Booking_StudioService]
values ('B006', 'STSV141', 'SA004', 1, 1)
/*data bảng IMG */
