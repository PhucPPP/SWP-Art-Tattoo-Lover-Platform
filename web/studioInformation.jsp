...
<html>
    ...
    <body>
        <div class="container" id="blur">
            ...
            <div class="service">
                ...
                <form action="MainController">
                    <table>
                        ...
                        <tbody id="table_body">
                            <tr>
                                ...
                                <td>
                                    <select id="select_service" class="tb-service" name="serviceID">
                                        <option></option>
                                ...
                                <td>
                                    <select id="select_service_detail" class="tb-detail" name="serviceDetailID">
                                    </select>
                                </td>
                                <td class="tb-size">
                    ...
                    <p class="total">TỔNG TIỀN: null</p>
                    <input type="hidden" name="studioID" value="${requestScope.STUDIO.id}"/>
                    <button class="btn-book" type="submit" name="action" value="Book"><i class="fa-regular fa-calendar-check"></i>ĐẶT LỊCH</button>
        ...
        <script>
            ...
            function addToService_detail(arr_name, arr_id) {
                let option = document.createElement("option");
                arr_name.forEach(function (item_name) {
                    option.text = item_name;
                });
                arr_id.forEach(function(item_id)) {
                    option.value = item_id;
                });
                select_service_detail.appendChild(option);
            }


            select_service.onchange = function () {
                select_service_detail.innerHTML = "<option></option>";
                if (this.value == "SV001") {
                    addToService_detail(service_detail_name_normal, service_detail_id_normal);
                }

                if (this.value == "SV002") {
                    addToService_detail(service_detail_name_color, service_detail_id_color);
                }
            };
        </script>
    </body>
