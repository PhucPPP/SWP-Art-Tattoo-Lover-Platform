<%-- 
    Document   : studioService
    Created on : Oct 18, 2023, 3:15:25 PM
    Author     : ASUS
--%>
...
<html>
    <head>
        ...
        <title>TIỆM XĂM THEO DỊCH VỤ</title>
        <link rel="stylesheet" href="Resource/css/studioServiceStyle.css">
    ...
    <body>
        <div class="container">
            ...
            <div class="content-title">
                <c:forEach var="service" items="${LIST_SERVICE_BY_ID}">
                    <h1>${service.name}</h1>
                </c:forEach>
                <c:forEach var="service" items="${LIST_SERVICE_DETAIL_BY_ID}">
                    <h1>${service.name}</h1>
                </c:forEach>
<!--                <select>
                    <option value="">Sắp xếp theo: Khoảng cách (ưu tiên gần nhất)</option>
                    <option value="">Sắp xếp theo: Khoảng cách (????????????????)</option>
                    <option value="">Sắp xếp theo: Khoảng cách (################)</option>
                </select>-->
            </div>
            <div class="content">
                <div class="filter">
                    <form>
                        ...
                        <c:forEach var="service_detail" items="${requestScope.LIST_SERVICE_DETAIL}">
                            <div class="filter-option">
                                 <c:choose>
                                    <c:when test="${service_detail.serviceDetailID == requestScope.SERVICE_ID}">
                ...
                <div class="studio-list">
                    ...
                    <c:forEach var="stu" items="${requestScope.LIST_SERVICE_STUDIO}">
                        <form action="MainController">
                                ...
                                <div class=" studio-content">
                                    ...
                                    <div class="studio-infor">
                                        ...
                                        <div class="studio-infor-item">
                                            <label>Giá từ:</label>
                                            <p> 
                                                <c:forEach var="min" items="${requestScope.LIST_MIN_PRICE}">
                    ...
                    <c:forEach var="stu" items="${requestScope.LIST_SERVICE_DETAIL_STUDIO}">
                        <form action="MainController">
                            <div class="studio-item">
                                <div class="studio-content">
                                    <div class="studio-avatar">
