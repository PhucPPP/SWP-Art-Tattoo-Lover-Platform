...
bookingStuServiceID nvarchar(15) primary key,
...
values ('TL001', 'hung3123', '123', 'TL', N'Nguyễn Việt Hùng', '2000-10-05', 'Male', '0569871253', 'nguyenhung@gmail.com', 'CT001', 'DT003', '1', null )
insert into [User]
values('SM001', 'toan3456', '123', 'SM', N'Trần Văn Toàn', '1980-12-02', 'Male', '01236987546', 'trantoan@gmail.com', 'CT001', 'DT002', '1', null)
insert into [User]
...
insert into [User]
values('AD001', 'trang8795', '123', 'AD', N'Trần Thị Thu Trang', '1990-11-25', 'Female', '0265879631', 'thutrang@gmail.com', 'CT001', 'DT010', '1', null )
/*data bảng Service*/
GO
...
/*data bảng Slot*/
GO
insert [Slot]([slotID], [studioID], [timeStart], [timeEnd], [status])
values('SL001', 'ST001', '11:00', '14:00', 1)
insert into [Slot]
values('SL002', 'ST001', '14:00', '16:30', 1)
insert into [Slot]
values('SL003', 'ST001', '16:30', '19:00', 1)
insert into [Slot]
values('SL004', 'ST002', '9:00', '12:00', 1)
insert into [Slot]
values('SL005', 'ST002', '12:00', '15:00', 1)
insert into [Slot]
values('SL006', 'ST002', '15:00', '18:00', 1)
insert into [Slot]
values('SL007', 'ST002', '18:00', '22:00', 1)
GO
/*data bảng Booking*/
insert [Booking]([bookingID], [userID], [fullName], [phoneNumber], [studioID], [studioStaffID], [slotID], [totalPrice], [description], [currentDate], [bookingDate], [rating], [commentation], [status])
values ('B001',  'TL001', N'Nguyễn Minh Hoàng', '0125478958', 'ST001', null, 'SL002', '15920000', N'1.Hình xăm con mèo, màu đen, mặt bự, chân ngắn, đuôi dài, đang vừa đi vừa cười 2.Hình con rồng to đùng màu xanh đỏ',
'2023-10-10 3:02', '2023-10-30', 0, null, N'Đang xử lý')
insert into [Booking]
values ('B002', 'TL001', N'Nguyễn Phạm Minh', '0125288958', 'ST001', 'SS001', 'SL001', '1100000', N'Hình con chó corgi màu vàng và màu trắng',
'2023-05-12 19:58', '2023-12-28', 0, null, N'Đã duyệt')
insert into [Booking]
values ('B003', 'TL001',  N'Nguyễn Hoàng Huy', '0125288925', 'ST001', 'SS001', 'SL001', '1100000', N'Hình con hổ màu trắng dễ thương',
'2022-01-15 8:09', '2022-02-25', 5, N'Hình xăm đẹp, tiệm xăm sạch sẽ', N'Hoàn thành')
insert into [Booking]
values ('B005', 'TL001', N'Trần Thế Hoàng', '0125268059', 'ST002', 'SS003', 'SL006', '300000', N'Hình con hổ màu trắng dễ thương',
'2022-01-13 14:33', '2022-02-28', 3, N'Hình xăm đẹp, tiệm xăm sạch sẽ', N'Hoàn thành')
insert into [Booking]
values ('B006', 'TL001', N'Trần Thế Khang', '0125268225', 'ST002', 'SS003', 'SL006', '300000', N'Hình con hổ màu trắng dễ thương',
'2022-01-14 7:33', '2022-02-27', 4, N'Hình xăm đẹp, tiệm xăm sạch sẽ', N'Hoàn thành')
/*data bảng Booking_StudioService*/
GO
insert [Booking_StudioService] ([bookingStuServiceID], [bookingID], [studioServiceID], [artistID], amount, [status])
values ('BSS001','B001', 'STSV015', null, 1, 1)
insert [Booking_StudioService]
values ('BSS002','B001', 'STSV078', null, 1, 1)
insert [Booking_StudioService]
values ('BSS003','B002', 'STSV074', 'SA001', 1, 1)
insert [Booking_StudioService]
values ('BSS004','B003', 'STSV074', 'SA002', 1, 1)
insert [Booking_StudioService]
values ('BSS005','B005', 'STSV141', 'SA004', 1, 1)
insert [Booking_StudioService]
values ('BSS006','B006', 'STSV141', 'SA004', 1, 1)
/*data bảng IMG */
GO
